        ...
        <form id="form">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Alternatif" name="alternatif" id="alternatif" required>
                </div>
            </div>
    ...
    $('#data').on('click','.edit',function(){
        ...
        <input type="hidden" name="aksi" id="aksi">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Label" name="label" id="label" required>
                </div>
                <div class="form-group">
                    <label for="alternatif">Alternatif</label>
                    <input type="text" class="form-control" placeholder="Masukkan Alternatif" name="alternatif" id="alternatif" required>
        ...
        $('#modal').find('#label').val($(this).data('label'));
        $('#modal').find('#alternatif').val($(this).data('alternatif'));
