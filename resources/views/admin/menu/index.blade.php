        ...
        <form id="form">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Nama Menu" name="title" id="title" required>
                </div>
                <div class="form-group">
                    <label for="icon">Icon</label>
                    <input type="text" class="form-control" placeholder="Masukkan kode Icon" name="icon" id="icon" required>
                </div>
                <div class="form-group">
...
$(document).ready(function(){
    ...
    table = $('.table').DataTable({
          ...
          columns: [
              ...
              {data: 'icon', name: 'icon'},
              {data: 'link', name: 'link'},
              {data: 'submenu', name: 'submenu',orderable: true,searchable: true},
